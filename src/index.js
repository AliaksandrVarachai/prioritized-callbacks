...
prioritizedCbController.addCallback(EVENTS.LOAD_FEEDBACK, 30, () => {
  console.log('callback with priority #30');
});
prioritizedCbController.addCallback(EVENTS.LOAD_FEEDBACK, 20, () => {
  console.log('callback with priority #20');
});
prioritizedCbController.addCallback(EVENTS.LOAD_FEEDBACK, 10, () => {
